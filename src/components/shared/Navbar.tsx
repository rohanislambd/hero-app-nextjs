    ...
    return (
        ...
        <nav className=" container mx-auto flex justify-between items-center py-4">
          ...
          <ul className="flex items-center gap-2 space-x-4 ">
              ...
              <li className='font-semibold hover:text-blue-500'><Link href="/apps">Apps</Link></li>
              <li className='font-semibold hover:text-blue-500'><Link href='instaillation'>Installation</Link></li>
          </ul>
